...
class Section(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Check if the instance is new or existing
    ...
    def calculate_dynamic_gap(cls, reference_section_id):
        ...
        reference_section = cls.objects.get(id=reference_section_id)
        previous_section, next_section = cls.find_adjacent_sections(
        ...
        if (
            previous_section
            and next_section
            and previous_section.number is not None
            and next_section.number is not None
        ):
