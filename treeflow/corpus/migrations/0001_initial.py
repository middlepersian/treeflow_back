# Generated by Django 4.1.4 on 2023-02-19 15:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('number', models.FloatField(blank=True, db_index=True, null=True)),
                ...
                ('transcription', models.CharField(db_index=True, max_length=50)),
                ('transliteration', models.CharField(blank=True, db_index=True, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='corpus.feature')),
                ('token', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='corpus.token')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dependency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='corpus.dependency')),
                ('token', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='corpus.token')),
            ],
        ),
        migrations.AddField(
            model_name='token',
            name='dependencies',
            field=models.ManyToManyField(blank=True, db_index=True, related_name='token_dependencies', through='corpus.TokenDependency', to='corpus.dependency'),
        ),
        migrations.AddField(
            model_name='token',
            name='features',
            field=models.ManyToManyField(blank=True, db_index=True, related_name='token_features', through='corpus.TokenFeature', to='corpus.feature'),
        ),
        migrations.AddField(
            model_name='token',
            name='lemmas',
            field=models.ManyToManyField(blank=True, db_index=True, related_name='token_lemmas', through='corpus.TokenLemma', to='dict.lemma'),
        ),
        migrations.AddField(
            model_name='token',
            name='meanings',
            field=models.ManyToManyField(blank=True, db_index=True, related_name='token_meanings', through='corpus.TokenMeaning', to='dict.meaning'),
        ),
        migrations.AddField(
            model_name='token',
            name='previous',
        ...
        migrations.AddField(
            model_name='token',
            name='related_tokens',
            field=models.ManyToManyField(blank=True, related_name='token_related_tokens', to='corpus.token'),
        ),
        migrations.AddField(
            model_name='token',
            name='text',
