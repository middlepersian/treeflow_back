    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False)),
                ('number', models.FloatField(blank=True, null=True)),
                ('number_in_sentence', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveBigIntegerField(blank=True, null=True), blank=True, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postfeatures', models.ManyToManyField(blank=True, related_name='token_postfeatures', to='corpus.morphologicalannotation')),
