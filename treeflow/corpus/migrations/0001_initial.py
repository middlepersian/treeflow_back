...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='source',
            name='references',
            field=models.ManyToManyField(related_name='source_references', to='corpus.bibentry'),
        ),
        migrations.AddField(
            model_name='source',
            name='sources',
            field=models.ManyToManyField(blank=True, related_name='source_sources', to='corpus.source'),
        ),
        migrations.AddField(
            model_name='section',
            name='container',
