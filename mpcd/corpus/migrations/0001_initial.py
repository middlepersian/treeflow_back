# Generated by Django 3.1.13 on 2022-06-03 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_suggestion', models.ManyToManyField(blank=True, related_name='token_new_suggestion', to='corpus.CommentCategory')),
                ...
                ('to_discuss', models.ManyToManyField(blank=True, related_name='token_to_discuss', to='corpus.CommentCategory')),
                ('uncertain', models.ManyToManyField(blank=True, related_name='token_uncertain', to='corpus.CommentCategory')),
            ],
            options={
                'ordering': ['number'],
            },
