# Generated by Django 3.1.13 on 2021-09-17 10:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=255)),
                ('stage', models.CharField(blank=True, choices=[('UNT', 'untouched'), ('IPR', 'in_progress'), ('FIN', 'finished')], max_length=3)),
        ...
        migrations.AddField(
            model_name='side',
            name='folio',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='corpus.folio'),
        ),
        migrations.AddField(
            model_name='resource',
            name='author',
        ...
        migrations.AddField(
            model_name='line',
            name='side',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='corpus.side'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='historicalline',
            name='side',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='corpus.side'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='codex',
            name='facsimile',
            field=models.ManyToManyField(to='corpus.BibEntry'),
        ),
        migrations.AddField(
            model_name='codex',
            name='scribe',
