# Generated by Django 3.1.13 on 2022-01-06 09:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
          ...
          migrations.CreateModel(
            ...
            fields=[
                ...
                ('lemma', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lemma_token', to='dict.entry')),
                ('morphological_annotation', models.ManyToManyField(blank=True, to='corpus.MorphologicalAnnotation')),
                ...
                ('syntactic_annotation', models.ManyToManyField(blank=True, to='corpus.Dependency')),
            ],
        ),
        migrations.CreateModel(
            name='CodexToken',
        ...
        migrations.AddField(
            model_name='text',
            name='collaborators',
            field=models.ManyToManyField(blank=True, related_name='collaborator_text', to='corpus.Author'),
        ),
        migrations.AddField(
            model_name='text',
            name='corpus',
        ...
        migrations.AddField(
            model_name='text',
            name='editors',
            field=models.ManyToManyField(blank=True, related_name='editor_text', to='corpus.Author'),
        ),
        migrations.AddField(
            model_name='text',
            name='resources',
        ...
        migrations.AddField(
            model_name='resource',
            name='authors',
            field=models.ManyToManyField(blank=True, related_name='author_resource', to='corpus.Author'),
        ),
        migrations.AddConstraint(
            model_name='pos',
        ...
        migrations.AddField(
            model_name='edition',
            name='text_sigle',
            field=models.ManyToManyField(blank=True, to='corpus.TextSigle'),
        ),
        migrations.AddField(
