    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pos', models.CharField(blank=True, choices=[('ADJ', 'adjective'), ('ADP', 'adposition'), ('ADV', 'adverb'), ('AUX', 'auxiliary'), ('CCONJ', 'coordinating conjunction'), ('DET', 'determiner'), ('INTJ', 'interjection'), ('NOUN', 'noun'), ('NUM', 'numeral'), ('PART', 'particle'), ('PRON', 'pronoun'), ('PROPN', 'proper noun'), ('PUNCT', 'punctuation'), ('SCONJ', 'subordinating conjunction'), ('SYM', 'symbol'), ('VERB', 'verb'), ('X', 'other')], max_length=8, null=True)),
                ('comment', models.TextField(blank=True)),
                ('avestan', models.URLField(blank=True, max_length=100, null=True)),
                ('gloss', models.TextField(blank=True, null=True)),
                ('comment_new_suggestion', models.ManyToManyField(blank=True, related_name='token_comment_new_suggestion', to='corpus.CommentCategory')),
                ('comment_to_discuss', models.ManyToManyField(blank=True, related_name='token_comment_to_discuss', to='corpus.CommentCategory')),
                ('comment_uncertain', models.ManyToManyField(blank=True, related_name='token_comment_uncertain', to='corpus.CommentCategory')),
                ('lemma', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='token_lemma', to='dict.lemma')),
