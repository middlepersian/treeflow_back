# Generated by Django 3.1.13 on 2021-08-20 14:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False)),
                ('tokens', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.token')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False)),
                ('section_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.chapter')),
                ('tokens', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.token')),
            ],
        ),
        migrations.CreateModel(
