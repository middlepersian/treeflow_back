# Generated by Django 3.1.13 on 2021-09-13 12:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, null=True)),
                ('comment', models.CharField(blank=True, max_length=255)),
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.chapter')),
            ],
        ),
        migrations.CreateModel(
            name='Strophe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('comment', models.CharField(blank=True, max_length=255)),
                ('verse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.strophe')),
            ],
        ),
        migrations.CreateModel(
            name='Text',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('text_sigle', models.CharField(choices=[], max_length=4, null=True)),
                ('name', models.CharField(max_length=100, null=True)),
                ('description', models.CharField(blank=True, max_length=255)),
                ('codex', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.codex')),
            ],
        ),
        migrations.AddField(
            model_name='strophe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('comment', models.CharField(blank=True, max_length=255)),
                ('folio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.folio')),
            ],
        ),
        migrations.CreateModel(
            name='Sentence',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('comment', models.CharField(blank=True, max_length=255)),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.section')),
            ],
        ),
        migrations.CreateModel(
