...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('comments', models.ManyToManyField(blank=True, related_name='semantic_comments', to='corpus.comment')),
        ...
        migrations.AddField(
            model_name='meaning',
            name='comments',
            field=models.ManyToManyField(blank=True, related_name='meaning_comments', to='corpus.comment'),
        ),
        migrations.AddField(
            model_name='meaning',
        ...
        migrations.AddField(
            model_name='lemma',
            name='comments',
            field=models.ManyToManyField(blank=True, related_name='lemma_comments', to='corpus.comment'),
        ),
        migrations.AddField(
            model_name='lemma',
            name='related_lemmas',
